...
void CpjsuaContainerView::HandleCommandL(TInt aCommand)
{
    ...
    switch (aCommand) {  // code to dispatch to the AknView's menu and CBA
                         // commands is generated here
    default:
        break;
    }
 ...
 */
void CpjsuaContainerView::DoActivateL(const TVwsViewId& /*aPrevViewId*/,
...
void CpjsuaContainerView::SetupStatusPaneL()
{
    ...
    if (subPaneTitle.IsPresent() && subPaneTitle.IsAppOwned()) {
        ...
        iEikonEnv->CreateResourceReaderLC(reader,
                                          R_PJSUA_CONTAINER_TITLE_RESOURCE);
...
/**
 *	Creates the top-level container for the view.  You may modify this
 *method's contents and the CPjsuaContainer::NewL() signature as needed to
 *initialize the container, but the signature for this method is fixed.
