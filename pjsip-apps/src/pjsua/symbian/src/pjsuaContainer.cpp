 ...
 */
CPjsuaContainer* CPjsuaContainer::NewL(const TRect& aRect,
                                       const CCoeControl* aParent,
                                       MEikCommandObserver* aCommandObserver)
{
    CPjsuaContainer* self =
      CPjsuaContainer::NewLC(aRect, aParent, aCommandObserver);
 ...
 */
CPjsuaContainer* CPjsuaContainer::NewLC(const TRect& aRect,
                                        const CCoeControl* aParent,
                                        MEikCommandObserver* aCommandObserver)
{
 ...
 * @param aParent owning parent, or NULL
 */
void CPjsuaContainer::ConstructL(const TRect& aRect, const CCoeControl* aParent,
                                 MEikCommandObserver* aCommandObserver)
{
    if (aParent == NULL) {
        CreateWindowL();
    ...
    ActivateL();
    // [[[ begin generated region: do not modify [Post-ActivateL
    // initializations]
 ...
 *	Handle key events.
 */
TKeyResponse CPjsuaContainer::OfferKeyEventL(const TKeyEvent& aKeyEvent,
                                             TEventCode aType)
{
    // [[[ begin generated region: do not modify [Generated Contents]
...
void CPjsuaContainer::InitializeControlsL()
{
    iImage1 = new (ELeave) CEikImage;
    {
        ...
        AknIconUtils::CreateIconL(bitmap, mask, KpjsuaFile, EMbmPjsuaPjsua, -1);
...
void CPjsuaContainer::HandleResourceChange(TInt aType)
{
    ...
    SetRect(
      iAvkonViewAppUi->View(TUid::Uid(EPjsuaContainerViewId))->ClientRect());
    // [[[ begin generated region: do not modify [Generated Contents]
    // ]]] end generated region [Generated Contents]
}
