...
class LOG {
    ...
    {
        Message msg =
          Message.obtain(h, CONST.MSG_TYPE.STR_DEBUG.ordinal(), str);
        msg.sendToTarget();
    }
    ...
    {
        Message msg =
          Message.obtain(h, CONST.MSG_TYPE.STR_ERROR.ordinal(), str);
        msg.sendToTarget();
    }
}
...
public class MainActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private static class MyCallback extends PjsuaAppCallback {
        ...
        @Override public void onStarted(String msg)
        {
            Handler ui = ui_handler.get();
            LOG.INFO(ui, msg);
        }

        @Override public void onStopped(int restart)
        {
            Handler ui = ui_handler.get();
            ...
            if (restart != 0) {
                ...
                Message msg =
                  Message.obtain(ui, CONST.MSG_TYPE.CLI_RESTART.ordinal());
                ui.sendMessageDelayed(msg, 100);
            } else {
                LOG.INFO(ui, "Telnet Stopping");
                Message msg =
                  Message.obtain(ui, CONST.MSG_TYPE.CLI_STOP.ordinal());
                ui.sendMessageDelayed(msg, 100);
            }
        }

        @Override public void onCallVideoStart()
        {
            MainActivity ma = ((MyHandler)ui_handler.get()).mTarget.get();
            SurfaceView surfaceView =
              (SurfaceView)ma.findViewById(R.id.surfaceViewIncomingCall);
    ...
    private int init_lib()
    {
        ...
        SurfaceView surfaceView =
          (SurfaceView)findViewById(R.id.surfaceViewIncomingCall);
