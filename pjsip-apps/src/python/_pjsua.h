 ...
 */
static PyObject* PyObj_pjsip_cred_info_new(PyTypeObject* type, PyObject* args,
                                           PyObject* kwds)
{
...
static PyMemberDef PyObj_pjsip_cred_info_members[] = {
    { "realm", T_OBJECT_EX, offsetof(PyObj_pjsip_cred_info, realm), 0,
      "Realm" },
    { "scheme", T_OBJECT_EX, offsetof(PyObj_pjsip_cred_info, scheme), 0,
      "Scheme" },
    { "username", T_OBJECT_EX, offsetof(PyObj_pjsip_cred_info, username), 0,
      "User name" },
    { "data", T_OBJECT_EX, offsetof(PyObj_pjsip_cred_info, data), 0,
      "The data, which can be a plaintext password or a hashed digest, "
      "depending on the value of data_type" },
    { "data_type", T_INT, offsetof(PyObj_pjsip_cred_info, data_type), 0,
      "Type of data" },
 ...
 */
static PyObject* PyObj_pjsua_callback_new(PyTypeObject* type, PyObject* args,
                                          PyObject* kwds)
{
...
static PyMemberDef PyObj_pjsua_callback_members[] = {
    ...
    { "on_reg_state", T_OBJECT_EX, offsetof(PyObj_pjsua_callback, on_reg_state),
      0,
    ...
    { "on_pager", T_OBJECT_EX, offsetof(PyObj_pjsua_callback, on_pager), 0,
    ...
    { "on_pager_status", T_OBJECT_EX,
      ...
      "request." },
    { "on_typing", T_OBJECT_EX, offsetof(PyObj_pjsua_callback, on_typing), 0,
      "Notify application about typing indication." },
    { "on_mwi_info", T_OBJECT_EX, offsetof(PyObj_pjsua_callback, on_mwi_info),
      0, "Notify application about MWI indication." },
    { NULL } /* Sentinel */
};
...
static PyMemberDef PyObj_pjsua_media_config_members[] = {
    { "clock_rate", T_INT, offsetof(PyObj_pjsua_media_config, clock_rate), 0,
    ...
    { "channel_count", T_INT, offsetof(PyObj_pjsua_media_config, channel_count),
      0, "Specify channel count (default 1)." },
    ...
    { "has_ioqueue", T_INT, offsetof(PyObj_pjsua_media_config, has_ioqueue), 0,
      ...
      "needed." },
    { "thread_cnt", T_INT, offsetof(PyObj_pjsua_media_config, thread_cnt), 0,
      "Specify the number of worker threads to handle incoming RTP packets. "
      "A value of one is recommended for most applications." },
    { "quality", T_INT, offsetof(PyObj_pjsua_media_config, quality), 0,
      "The media quality also sets speex codec quality/complexity to the "
      "number." },
    { "ptime", T_INT, offsetof(PyObj_pjsua_media_config, ptime), 0,
      "Specify default ptime." },
    { "no_vad", T_INT, offsetof(PyObj_pjsua_media_config, no_vad), 0,
      "Disable VAD?" },
    { "ilbc_mode", T_INT, offsetof(PyObj_pjsua_media_config, ilbc_mode), 0,
      "iLBC mode (20 or 30)." },
    { "tx_drop_pct", T_INT, offsetof(PyObj_pjsua_media_config, tx_drop_pct), 0,
      "Percentage of RTP packet to drop in TX direction (to simulate packet "
      "lost)." },
    { "rx_drop_pct", T_INT, offsetof(PyObj_pjsua_media_config, rx_drop_pct), 0,
      "Percentage of RTP packet to drop in RX direction (to simulate packet "
      "lost)." },
    { "ec_options", T_INT, offsetof(PyObj_pjsua_media_config, ec_options), 0,
      "Echo canceller options (see pjmedia_echo_create())" },
    { "ec_tail_len", T_INT, offsetof(PyObj_pjsua_media_config, ec_tail_len), 0,
      "Echo canceller tail length, in miliseconds." },
    { "jb_min", T_INT, offsetof(PyObj_pjsua_media_config, jb_min), 0,
      "Jitter buffer minimum size in milliseconds." },
    { "jb_max", T_INT, offsetof(PyObj_pjsua_media_config, jb_max), 0,
      "Jitter buffer maximum size in milliseconds." },
    { "enable_ice", T_INT, offsetof(PyObj_pjsua_media_config, enable_ice), 0,
      "Enable ICE." },
    { "enable_turn", T_INT, offsetof(PyObj_pjsua_media_config, enable_turn), 0,
      "Enable TURN." },
    ...
    { "turn_realm", T_OBJECT_EX, offsetof(PyObj_pjsua_media_config, turn_realm),
      0, "Specify the TURN realm." },
                                            ...
                                            const PyObj_pjsua_media_config* obj)
{
    ...
    if (cfg->enable_turn) {
        ...
        cfg->turn_auth_cred.data.static_cred.realm =
          PyString_ToPJ(obj->turn_realm);
        cfg->turn_auth_cred.data.static_cred.username =
          PyString_ToPJ(obj->turn_username);
        cfg->turn_auth_cred.data.static_cred.data_type = obj->turn_passwd_type;
        cfg->turn_auth_cred.data.static_cred.data =
          PyString_ToPJ(obj->turn_passwd);
    }
}
...
static PyObject* PyObj_pjsua_config_new(PyTypeObject* type, PyObject* args,
                                        PyObject* kwds)
{
    ...
    if (self != NULL) {
        ...
        self->cb = (PyObj_pjsua_callback*)PyType_GenericNew(
          &PyTyp_pjsua_callback, NULL, NULL);
    }
    return (PyObject*)self;
}
...
static PyMemberDef PyObj_pjsua_config_members[] = {
    { "max_calls", T_INT, offsetof(PyObj_pjsua_config, max_calls), 0,
      "Maximum calls to support (default: 4) " },
    { "thread_cnt", T_INT, offsetof(PyObj_pjsua_config, thread_cnt), 0,
    ...
    { "stun_domain", T_OBJECT_EX, offsetof(PyObj_pjsua_config, stun_domain), 0,
    ...
    { "stun_host", T_OBJECT_EX, offsetof(PyObj_pjsua_config, stun_host), 0,
      "Hostname or IP address of the STUN server (optional)." },
    { "nameserver", T_OBJECT_EX, offsetof(PyObj_pjsua_config, nameserver), 0,
...
static PyMemberDef PyObj_pjsua_logging_config_members[] = {
    { "msg_logging", T_INT, offsetof(PyObj_pjsua_logging_config, msg_logging),
      0, "Log incoming and outgoing SIP message? Yes!" },
    { "level", T_INT, offsetof(PyObj_pjsua_logging_config, level), 0,
      "Input verbosity level. Value 5 is reasonable." },
    { "console_level", T_INT,
      offsetof(PyObj_pjsua_logging_config, console_level), 0,
      "Verbosity level for console. Value 4 is reasonable." },
    { "decor", T_INT, offsetof(PyObj_pjsua_logging_config, decor), 0,
      "Log decoration" },
    { "log_filename", T_OBJECT_EX,
      offsetof(PyObj_pjsua_logging_config, log_filename), 0,
      "Optional log filename" },
    { "cb", T_OBJECT_EX, offsetof(PyObj_pjsua_logging_config, cb), 0,
 ...
 * !modified @ 061206
 */
static PyObject* PyObj_pjsua_msg_data_new(PyTypeObject* type, PyObject* args,
                                          PyObject* kwds)
{
...
static PyMemberDef PyObj_pjsua_msg_data_members[] = {
    { "hdr_list", T_OBJECT_EX, offsetof(PyObj_pjsua_msg_data, hdr_list), 0,
      "Additional message headers as linked list of strings." },
    { "content_type", T_OBJECT_EX, offsetof(PyObj_pjsua_msg_data, content_type),
      0, "MIME type of optional message body." },
    { "msg_body", T_OBJECT_EX, offsetof(PyObj_pjsua_msg_data, msg_body), 0,
 ...
 */
static void PyObj_pjsua_transport_config_delete(
...
static void PyObj_pjsua_transport_config_export(
  pjsua_transport_config* cfg, PyObj_pjsua_transport_config* obj)
{
...
static void PyObj_pjsua_transport_config_import(
  PyObj_pjsua_transport_config* obj, const pjsua_transport_config* cfg)
{
...
static PyMemberDef PyObj_pjsua_transport_config_members[] = {
    { "port", T_INT, offsetof(PyObj_pjsua_transport_config, port), 0,
    ...
    { "qos_type", T_INT, offsetof(PyObj_pjsua_transport_config, qos_type), 0,
...
static PyMemberDef PyObj_pjsua_transport_info_members[] = {
    { "id", T_INT, offsetof(PyObj_pjsua_transport_info, id), 0,
      "PJSUA transport identification." },
    { "type", T_INT, offsetof(PyObj_pjsua_transport_info, type), 0,
      "Transport type." },
    { "type_name", T_OBJECT_EX, offsetof(PyObj_pjsua_transport_info, type_name),
      0, "Transport type name." },
    { "info", T_OBJECT_EX, offsetof(PyObj_pjsua_transport_info, info), 0,
      "Transport string info/description." },
    { "flag", T_INT, offsetof(PyObj_pjsua_transport_info, flag), 0,
      "Transport flag (see ##pjsip_transport_flags_e)." },
    { "addr", T_OBJECT_EX, offsetof(PyObj_pjsua_transport_info, addr), 0,
      "Published address (or transport address name)." },
    { "port", T_INT, offsetof(PyObj_pjsua_transport_info, port), 0,
      "Published port number." },
    { "usage_count", T_INT, offsetof(PyObj_pjsua_transport_info, usage_count),
      0, "Current number of objects currently referencing this transport." },
    { NULL } /* Sentinel */
};
                                          ...
                                          const pjsua_acc_config* cfg)
{
    ...
    for (i = 0; i < cfg->cred_count; ++i) {
        ...
        ci = (PyObj_pjsip_cred_info*)PyObj_pjsip_cred_info_new(
          &PyTyp_pjsip_cred_info, NULL, NULL);
    ...
    tconf = (PyObj_pjsua_transport_config*)PyObj_pjsua_transport_config_new(
      &PyTyp_pjsua_transport_config, NULL, NULL);
                                          ...
                                          PyObj_pjsua_acc_config* obj)
{
    ...
    for (i = 0; i < cfg->cred_count; i++) {
        PyObj_pjsip_cred_info* ci;
        ci =
          (PyObj_pjsip_cred_info*)PyList_GetItem((PyObject*)obj->cred_info, i);
 ...
 */
static PyObject* PyObj_pjsua_acc_config_new(PyTypeObject* type, PyObject* args,
                                            PyObject* kwds)
{
...
static PyMemberDef PyObj_pjsua_acc_config_members[] = {
    ...
    { "id", T_OBJECT_EX, offsetof(PyObj_pjsua_acc_config, id), 0,
    ...
    { "reg_uri", T_OBJECT_EX, offsetof(PyObj_pjsua_acc_config, reg_uri), 0,
    ...
    { "publish_enabled", T_INT,
      ...
      "Publish presence? " },
    { "mwi_enabled", T_INT, offsetof(PyObj_pjsua_acc_config, mwi_enabled), 0,
    ...
    { "proxy", T_OBJECT_EX, offsetof(PyObj_pjsua_acc_config, proxy), 0,
    ...
    { "cred_info", T_OBJECT_EX, offsetof(PyObj_pjsua_acc_config, cred_info), 0,
    ...
    { "transport_id", T_INT, offsetof(PyObj_pjsua_acc_config, transport_id), 0,
    ...
    { "pidf_tuple_id", T_OBJECT_EX,
      offsetof(PyObj_pjsua_acc_config, pidf_tuple_id), 0, "PIDF tuple id." },
    ...
    { "require_100rel", T_INT, offsetof(PyObj_pjsua_acc_config, require_100rel),
      0, "Require reliable provisional response." },
    { "use_timer", T_INT, offsetof(PyObj_pjsua_acc_config, use_timer), 0,
      "Use SIP session timers? (default=1)"
      "0:inactive, 1:optional, 2:mandatory, 3:always" },
    { "timer_se", T_INT, offsetof(PyObj_pjsua_acc_config, timer_se), 0,
      "Session timer expiration period, in seconds." },
    { "timer_min_se", T_INT, offsetof(PyObj_pjsua_acc_config, timer_min_se), 0,
    ...
    { "ka_interval", T_INT, offsetof(PyObj_pjsua_acc_config, ka_interval), 0,
      "Keep-alive interval." },
    { "ka_data", T_OBJECT_EX, offsetof(PyObj_pjsua_acc_config, ka_data), 0,
      "Keep-alive data." },
    { "use_srtp", T_INT, offsetof(PyObj_pjsua_acc_config, use_srtp), 0,
      "Specify SRTP usage." },
 ...
 */
static PyObject* PyObj_pjsua_acc_info_new(PyTypeObject* type, PyObject* args,
                                          PyObject* kwds)
{
...
static PyMemberDef acc_info_members[] = {
    { "id", T_INT, offsetof(PyObj_pjsua_acc_info, id), 0, "The account ID." },
    { "is_default", T_INT, offsetof(PyObj_pjsua_acc_info, is_default), 0,
      "Flag to indicate whether this is the default account. " },
    { "acc_uri", T_OBJECT_EX, offsetof(PyObj_pjsua_acc_info, acc_uri), 0,
      "Account URI" },
    ...
    { "expires", T_INT, offsetof(PyObj_pjsua_acc_info, expires), 0,
      "An up to date expiration interval for account registration session." },
    { "status", T_INT, offsetof(PyObj_pjsua_acc_info, status), 0,
    ...
    { "status_text", T_OBJECT_EX, offsetof(PyObj_pjsua_acc_info, status_text),
      0, "String describing the registration status." },
    { "online_status", T_INT, offsetof(PyObj_pjsua_acc_info, online_status), 0,
...
static PyMemberDef PyObj_pjsua_buddy_config_members[] = {
    ...
    { "uri", T_OBJECT_EX, offsetof(PyObj_pjsua_buddy_config, uri), 0,
      "TBuddy URL or name address." },

    { "subscribe", T_INT, offsetof(PyObj_pjsua_buddy_config, subscribe), 0,
 ...
 * !modified @ 071206
 */
static PyObject* PyObj_pjsua_buddy_info_new(PyTypeObject* type, PyObject* args,
                                            PyObject* kwds)
{
...
static PyMemberDef PyObj_pjsua_buddy_info_members[] = {
    { "id", T_INT, offsetof(PyObj_pjsua_buddy_info, id), 0, "The buddy ID." },
    { "uri", T_OBJECT_EX, offsetof(PyObj_pjsua_buddy_info, uri), 0,
      "The full URI of the buddy, as specified in the configuration. " },
    { "contact", T_OBJECT_EX, offsetof(PyObj_pjsua_buddy_info, contact), 0,
      "Buddy's Contact, only available when presence subscription "
      "has been established to the buddy." },
    { "status", T_INT, offsetof(PyObj_pjsua_buddy_info, status), 0,
      "Buddy's online status. " },
    { "status_text", T_OBJECT_EX, offsetof(PyObj_pjsua_buddy_info, status_text),
      0, "Text to describe buddy's online status." },
    { "monitor_pres", T_INT, offsetof(PyObj_pjsua_buddy_info, monitor_pres), 0,
      "Flag to indicate that we should monitor the presence information "
      "for this buddy (normally yes, unless explicitly disabled). " },
    { "activity", T_INT, offsetof(PyObj_pjsua_buddy_info, activity), 0,
      "Activity type. " },
    { "sub_state", T_INT, offsetof(PyObj_pjsua_buddy_info, sub_state), 0,
      "Subscription state." },
...
static PyMemberDef codec_info_members[] = {
    { "codec_id", T_OBJECT_EX, offsetof(PyObj_pjsua_codec_info, codec_id), 0,
      "Codec unique identification." },
    { "priority", T_INT, offsetof(PyObj_pjsua_codec_info, priority), 0,
...
static PyMemberDef conf_port_info_members[] = {
    { "slot_id", T_INT, offsetof(PyObj_pjsua_conf_port_info, slot_id), 0,
      "Conference port number." },
    { "name", T_OBJECT_EX, offsetof(PyObj_pjsua_conf_port_info, name), 0,
      "Port name" },
    { "clock_rate", T_INT, offsetof(PyObj_pjsua_conf_port_info, clock_rate), 0,
      "Clock rate" },
    { "channel_count", T_INT,
    ...
    { "bits_per_sample", T_INT,
      ...
      "Bits per sample" },
    { "listeners", T_OBJECT_EX, offsetof(PyObj_pjsua_conf_port_info, listeners),
      0,
...
static PyMemberDef pjmedia_snd_dev_info_members[] = {
    { "input_count", T_INT, offsetof(PyObj_pjmedia_snd_dev_info, input_count),
      0, "Max number of input channels" },
    { "output_count", T_INT, offsetof(PyObj_pjmedia_snd_dev_info, output_count),
      0, "Max number of output channels" },
    { "default_samples_per_sec", T_INT,
      offsetof(PyObj_pjmedia_snd_dev_info, default_samples_per_sec), 0,
      "Default sampling rate." },
    { "name", T_OBJECT_EX, offsetof(PyObj_pjmedia_snd_dev_info, name), 0,
      "Device name" },
...
static PyMemberDef pjmedia_codec_param_info_members[] = {
    { "clock_rate", T_INT, offsetof(PyObj_pjmedia_codec_param_info, clock_rate),
      0, "Sampling rate in Hz" },
    { "channel_cnt", T_INT,
      offsetof(PyObj_pjmedia_codec_param_info, channel_cnt), 0,
      "Channel count" },
    { "avg_bps", T_INT, offsetof(PyObj_pjmedia_codec_param_info, avg_bps), 0,
      "Average bandwidth in bits/sec" },
    { "frm_ptime", T_INT, offsetof(PyObj_pjmedia_codec_param_info, frm_ptime),
      0, "Base frame ptime in msec." },
    { "pcm_bits_per_sample", T_INT,
      offsetof(PyObj_pjmedia_codec_param_info, pcm_bits_per_sample), 0,
      "Bits/sample in the PCM side" },
    { "pt", T_INT, offsetof(PyObj_pjmedia_codec_param_info, pt), 0,
      "Payload type" },
...
static PyMemberDef pjmedia_codec_param_setting_members[] = {
    ...
    { "vad", T_INT, offsetof(PyObj_pjmedia_codec_param_setting, vad), 0,
      "Voice Activity Detector" },
    { "cng", T_INT, offsetof(PyObj_pjmedia_codec_param_setting, cng), 0,
      "Comfort Noise Generator" },
    { "penh", T_INT, offsetof(PyObj_pjmedia_codec_param_setting, penh), 0,
      "Perceptual Enhancement" },
    { "plc", T_INT, offsetof(PyObj_pjmedia_codec_param_setting, plc), 0,
                                         ...
                                         PyObject* kwds)
{
    ...
    if (self != NULL) {
        self->info = (PyObj_pjmedia_codec_param_info*)PyType_GenericNew(
          &PyTyp_pjmedia_codec_param_info, NULL, NULL);
        self->setting = (PyObj_pjmedia_codec_param_setting*)PyType_GenericNew(
          &PyTyp_pjmedia_codec_param_setting, NULL, NULL);
    }
    return (PyObject*)self;
}
...
static PyMemberDef pjmedia_codec_param_members[] = {
    ...
    { "info", T_OBJECT_EX, offsetof(PyObj_pjmedia_codec_param, info), 0,
      "The 'info' part of codec param describes the capability of the codec,"
      " and the value should NOT be changed by application." },
    { "setting", T_OBJECT_EX, offsetof(PyObj_pjmedia_codec_param, setting), 0,
...
static PyMemberDef call_info_members[] = {
    { "id", T_INT, offsetof(PyObj_pjsua_call_info, id), 0,
      "Call identification" },
    { "role", T_INT, offsetof(PyObj_pjsua_call_info, role), 0,
      "Initial call role (UAC == caller)" },
    { "acc_id", T_INT, offsetof(PyObj_pjsua_call_info, acc_id), 0,
      "The account ID where this call belongs." },
    { "local_info", T_OBJECT_EX, offsetof(PyObj_pjsua_call_info, local_info), 0,
      "Local URI" },
    { "local_contact", T_OBJECT_EX,
      offsetof(PyObj_pjsua_call_info, local_contact), 0, "Local Contact" },
    { "remote_info", T_OBJECT_EX, offsetof(PyObj_pjsua_call_info, remote_info),
      0, "Remote URI" },
    { "remote_contact", T_OBJECT_EX,
      offsetof(PyObj_pjsua_call_info, remote_contact), 0, "Remote Contact" },
    { "call_id", T_OBJECT_EX, offsetof(PyObj_pjsua_call_info, call_id), 0,
      "Dialog Call-ID string" },
    { "state", T_INT, offsetof(PyObj_pjsua_call_info, state), 0, "Call state" },
    { "state_text", T_OBJECT_EX, offsetof(PyObj_pjsua_call_info, state_text), 0,
      "Text describing the state " },
    { "last_status", T_INT, offsetof(PyObj_pjsua_call_info, last_status), 0,
    ...
    { "media_status", T_INT, offsetof(PyObj_pjsua_call_info, media_status), 0,
      "Call media status." },
    { "media_dir", T_INT, offsetof(PyObj_pjsua_call_info, media_dir), 0,
      "Media direction" },
    { "conf_slot", T_INT, offsetof(PyObj_pjsua_call_info, conf_slot), 0,
    ...
    { "total_duration", T_INT, offsetof(PyObj_pjsua_call_info, total_duration),
      0, "Total call duration, including set-up time" },
...
static void PyObj_pjsip_rx_data_import(PyObj_pjsip_rx_data* obj,
 ...
 */
static PyObject* PyObj_pjsip_rx_data_new(PyTypeObject* type, PyObject* args,
                                         PyObject* kwds)
{
...
static PyMemberDef PyObj_pjsip_rx_data_members[] = {
    { "msg_info_buffer", T_OBJECT_EX,
      offsetof(PyObj_pjsip_rx_data, msg_info_buffer), 0, "Entire SIP-Message" },
    { "msg_info_info", T_OBJECT_EX,
      offsetof(PyObj_pjsip_rx_data, msg_info_info), 0, "Message Info" },
