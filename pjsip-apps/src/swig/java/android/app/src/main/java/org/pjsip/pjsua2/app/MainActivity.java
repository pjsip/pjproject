...
public class MainActivity
  extends Activity implements Handler.Callback, MyAppObserver {
    ...
    @Override protected void onCreate(Bundle savedInstanceState)
    {
        ...
        buddyListAdapter = new SimpleAdapter(
          this, buddyList, android.R.layout.simple_list_item_2, from, to);
    ...
    @Override public boolean handleMessage(Message m)
    {
        if (m.what == 0) {
            ...
            if (currentCall == null || ci == null ||
                ci.getId() != currentCall.getId()) {
                System.out.println(
                  "Call state event received, but call info is invalid");
                return true;
            }
    ...
    private void dlgAccountSetting()
    {
        ...
        final EditText etReg =
          (EditText)view.findViewById(R.id.editTextRegistrar);
        final EditText etProxy =
          (EditText)view.findViewById(R.id.editTextProxy);
        final EditText etUser =
          (EditText)view.findViewById(R.id.editTextUsername);
        final EditText etPass =
    ...
    public void makeCall(View view)
    {
        ...
        HashMap<String, String> item =
          (HashMap<String, String>)buddyListView.getItemAtPosition(
            buddyListSelectedIdx);
    ...
    private void dlgAddEditBuddy(BuddyConfig initial)
    {
        ...
        final CheckBox cbSubs =
          (CheckBox)view.findViewById(R.id.checkBoxSubscribe);
            ...
            public void onClick(DialogInterface dialog, int id)
            {
                ...
                if (is_add) {
                    ...
                    if (!old_cfg.getUri().equals(cfg.getUri())) {
                        ...
                        MyBuddy bud =
                          account.buddyList.get(buddyListSelectedIdx);
                        try {
