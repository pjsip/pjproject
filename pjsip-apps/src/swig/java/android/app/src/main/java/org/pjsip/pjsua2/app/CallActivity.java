...
public class CallActivity
  extends Activity implements Handler.Callback, SurfaceHolder.Callback {
    ...
    @Override protected void onCreate(Bundle savedInstanceState)
    {
        ...
        SurfaceView surfaceInVideo =
          (SurfaceView)findViewById(R.id.surfaceIncomingVideo);
        SurfaceView surfacePreview =
          (SurfaceView)findViewById(R.id.surfacePreviewCapture);
    ...
    {
        surfacePreview.setVisibility(
          previewHandler.videoPreviewActive ? View.VISIBLE : View.GONE);
