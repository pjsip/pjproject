                                     ...
                                     const pj_ioqueue_callback *cb)
{
    ...
    key->inside_read_callback = PJ_FALSE;
...
invoke_cb:
        ...
        /* Set the flag indicating we are in the read callback */
        h->inside_read_callback = PJ_TRUE;
        ...
        h->inside_read_callback = PJ_FALSE;
        pj_ioqueue_unlock_key(h);
