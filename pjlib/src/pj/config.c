...
PJ_DEF_DATA(const char*)
PJ_VERSION = PJ_MAKE_VERSION4_2(PJ_VERSION_NUM_MAJOR, PJ_VERSION_NUM_MINOR,
                                PJ_VERSION_NUM_REV, PJ_VERSION_NUM_EXTRA);
#else
PJ_DEF_DATA(const char*)
PJ_VERSION = PJ_MAKE_VERSION3_2(PJ_VERSION_NUM_MAJOR, PJ_VERSION_NUM_MINOR,
...
PJ_DEF(void) pj_dump_config(void)
{
    ...
    PJ_LOG(3,
           (id, " PJ_FUNCTIONS_ARE_INLINED  : %d", PJ_FUNCTIONS_ARE_INLINED));
    ...
    PJ_LOG(3,
           (id, " PJ_IOQUEUE_HAS_SAFE_UNREG : %d", PJ_IOQUEUE_HAS_SAFE_UNREG));
    ...
    PJ_LOG(3,
           (id, " PJ_EXCEPTION_USE_WIN32_SEH: %d", PJ_EXCEPTION_USE_WIN32_SEH));
