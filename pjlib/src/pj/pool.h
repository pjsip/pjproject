/* $Header: /cvs/pjproject-0.2.9.3/pjlib/src/pj/pool.h,v 1.1 2005/12/02 20:02:30 nn Exp $ */
/* 
 ...
 */
PJ_IDECL(pj_pool_t*) pj_pool_create(pj_pool_factory *f, 
				    const char *name,
 ...
 */
#define PJ_NO_MEMORY_EXCEPTION	1
 ...
 */
PJ_DECL(pj_pool_t*) pj_pool_create_int(	pj_pool_factory *f, 
					const char *name,
					pj_size_t initial_size, 
					pj_size_t increment_size,
					pj_pool_callback *callback);
...
{
    pj_pool_factory factory;
    pj_size_t	    capacity, max_capacity, used_count;
