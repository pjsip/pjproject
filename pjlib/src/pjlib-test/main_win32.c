...
ATOM MyRegisterClass(HINSTANCE hInstance, LPTSTR szWindowClass)
{
    ...
    /// MAKEINTRESOURCE(IDI_HELLO_WINCE));
    wc.hIcon = NULL;
    wc.hCursor = 0;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    hWnd = CreateWindow(szWindowClass, szTitle, WS_VISIBLE, CW_USEDEFAULT,
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        dwStyle = WS_CHILD | WS_VISIBLE | WS_HSCROLL | WS_VSCROLL | WS_BORDER |
