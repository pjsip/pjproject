...
#    define PJ_WIN32           1
  ...
  defined(WIN32) || defined(PJ_WIN64) || defined(_WIN64) || defined(WIN64) || \
  defined(__TOS_WIN__)
...
#elif defined(PJ_DARWINOS) || defined(__MACOSX__) || defined(__APPLE__) || \
  defined(__MACH__)
/*
 * MacOS X
 */
...
#    include <pj/compat/m_auto.h>
  ...
  defined(_X86_) || defined(x86) || defined(__i386__) || defined(__i386) || \
  defined(_M_IX86) || defined(__I86__)
/*
 ...
 *  must be enabled.
 */
#if (PJ_IOQUEUE_DEFAULT_ALLOW_CONCURRENCY == 0) && \
  (PJ_IOQUEUE_HAS_SAFE_UNREG == 0)
...
#    ifdef _MSC_VER
#        pragma message( \
          "Warning: PJ_ENABLE_EXTRA_CHECK macro is deprecated" \
          " and has no effect")
#    else
...
#define PJ_SSL_SOCK_IMP_DARWIN \
    3 /**< Using Apple's Secure \
           Transport (deprecated in \
           MacOS 10.15 & iOS 13.0)*/
#define PJ_SSL_SOCK_IMP_APPLE \
    4 /**< Using Apple's Network \
           framework.	    	    */
...
#define PJ_VERSION_NUM \
    ((PJ_VERSION_NUM_MAJOR << 24) | (PJ_VERSION_NUM_MINOR << 16) | \
