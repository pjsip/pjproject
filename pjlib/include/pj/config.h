...
#define PJMEDIA_CONF_USE_SWITCH_BOARD_BACKEND 0
#define PJMEDIA_CONF_USE_BRIDGE_ST_MODE 1
#define PJMEDIA_CONF_USE_BRIDGE_MT_MODE 2
//#define PJMEDIA_CONF_USE_OPENMP 3

#ifndef PJMEDIA_CONF_BACKEND
#   ifdef PJMEDIA_CONF_USE_SWITCH_BOARD
#       define PJMEDIA_CONF_BACKEND PJMEDIA_CONF_USE_SWITCH_BOARD_BACKEND
#   elif defined(PJMEDIA_CONF_THREADS) && PJMEDIA_CONF_THREADS>1
#       define PJMEDIA_CONF_BACKEND PJMEDIA_CONF_USE_BRIDGE_MT_MODE
#   else
#       define PJMEDIA_CONF_BACKEND PJMEDIA_CONF_USE_BRIDGE_ST_MODE
