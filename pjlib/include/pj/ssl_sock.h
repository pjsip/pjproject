 ...
 */
PJ_DECL(pj_ssize_t)
pj_ssl_cert_info_dump(const pj_ssl_cert_info* ci, const char* indent, char* buf,
                      pj_size_t buf_size);
 ...
 */
PJ_DECL(pj_status_t)
pj_ssl_cert_get_verify_status_strings(pj_uint32_t verify_status,
...
typedef struct pj_ssl_sock_cb
{
     ...
     */
    pj_bool_t (*on_data_read)(pj_ssl_sock_t* ssock, void* data, pj_size_t size,
     ...
     *			callback and return PJ_FALSE here.
     */
    pj_bool_t (*on_data_recvfrom)(pj_ssl_sock_t* ssock, void* data,
 ...
 */
PJ_DECL(void)
pj_ssl_sock_param_copy(pj_pool_t* pool, pj_ssl_sock_param* dst,
