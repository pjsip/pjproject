...
/**
 * @defgroup socket_qos Socket Quality of Service (QoS) API: TOS, DSCP, WMM,
 IEEE 802.1p
 * @ingroup PJ_SOCK
 * @{
 ...
 */
PJ_DECL(pj_status_t) pj_sock_set_qos_type(pj_sock_t sock, pj_qos_type type);
 ...
 *		    or approximated..
 */
PJ_DECL(pj_status_t) pj_sock_get_qos_type(pj_sock_t sock, pj_qos_type* p_type);
