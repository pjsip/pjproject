 ...
 */
#ifndef __PJ_COMPAT_CC_BCB_H__
#define __PJ_COMPAT_CC_BCB_H__
...
#  error "This header file is only for cbuilder compiler!"
#endif

#define PJ_CC_NAME	    "cbuilder"
#define PJ_CC_VER_1	    ((__CODEGEARC_VERSION__ & 0xFF000000) >> 24)
#define PJ_CC_VER_2	    ((__CODEGEARC_VERSION__ & 0x00FF0000) >> 16)
#define PJ_CC_VER_3	    ((__CODEGEARC_VERSION__ & 0x0000FFFF))
