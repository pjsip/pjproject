...
PJ_IDEF(pj_str_t*) pj_strdup2(pj_pool_t* pool, pj_str_t* dst, const char* src)
{
...
PJ_IDEF(int) pj_strncmp2(const pj_str_t* str1, const char* str2, pj_size_t len)
{
    pj_str_t copy2;
...
PJ_IDEF(int) strnicmp_alnum(const char* str1, const char* str2, int len)
{
    if (len == 0)
        return 0;
    else {
...
PJ_IDEF(int) pj_strnicmp2(const pj_str_t* str1, const char* str2, pj_size_t len)
{
    pj_str_t copy2;
