 ...
 */
 ...
 // Change for ilogixx:
/* compile library for maximum speed and volume*/
#define PJ_CONFIG_MAXIMUM_SPEED
#undef PJ_CONFIG_MINIMAL_SIZE
/*
...
#   define PJSIP_MAX_DIALOG_COUNT	(1024-1)
...
#   define PJSUA_MAX_BUDDIES	    1024
#   if defined(PJ_WIN32) || defined(PJ_WIN64) 
#     define PJSIP_MAX_NET_EVENTS	PJ_IOQUEUE_MAX_HANDLES
#   endif
