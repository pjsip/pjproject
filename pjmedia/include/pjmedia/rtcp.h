 ...
 */
PJ_DECL(void)
pjmedia_rtcp_init(pjmedia_rtcp_session* session, char* name,
 ...
 */
PJ_DECL(void)
pjmedia_rtcp_init2(pjmedia_rtcp_session* session,
 ...
 */
PJ_DECL(void)
pjmedia_rtcp_rx_rtp(pjmedia_rtcp_session* session, unsigned seq, unsigned ts,
                    unsigned payload);
 ...
 */
PJ_DECL(void)
pjmedia_rtcp_rx_rtp2(pjmedia_rtcp_session* session, unsigned seq, unsigned ts,
 ...
 */
PJ_DECL(void)
pjmedia_rtcp_tx_rtp(pjmedia_rtcp_session* session, unsigned ptsize);
 ...
 */
PJ_DECL(void)
pjmedia_rtcp_rx_rtcp(pjmedia_rtcp_session* session, const void* rtcp_pkt,
                     pj_size_t size);
 ...
 */
PJ_DECL(void)
pjmedia_rtcp_build_rtcp(pjmedia_rtcp_session* session, void** rtcp_pkt,
                        int* len);
