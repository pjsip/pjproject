...
#define PJMEDIA_SIG_IS_CLASS_AUD_CODEC(s) \
    ((s) >> 24 == 'C' && (((s) >> 16) & 0xff) == 'A')
...
#define PJMEDIA_SIG_IS_CLASS_VID_CODEC(sig) \
    ((s) >> 24 == 'C' && (((s) >> 16) & 0xff) == 'V')
...
#define PJMEDIA_SIG_IS_CLASS_PORT_AUD(s) \
    ((s) >> 24 == 'P' && (((s) >> 16) & 0xff) == 'A')
...
#define PJMEDIA_SIG_IS_CLASS_PORT_VID(s) \
    ((s) >> 24 == 'P' && (((s) >> 16) & 0xff) == 'V')
...
#define PJMEDIA_SIG_IS_CLASS_VID_DEV(s) \
    ((s) >> 24 == 'V' && (((s) >> 16) & 0xff) == 'D')
...
#define PJMEDIA_SIG_IS_CLASS_VID_OTHER(s) \
    ((s) >> 24 == 'V' && (((s) >> 16) & 0xff) == 'O')
