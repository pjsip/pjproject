 ...
 */
#define PJMEDIA_ERRNO_FROM_PORTAUDIO(err) \
...
#    define PJMEDIA_SRTP_ECRYPTONOTMATCH \
        (PJMEDIA_ERRNO_START + 220) /* 220220 */
/**
 * @hideinitializer
...
#    define PJMEDIA_SRTP_ESDPDUPCRYPTOTAG \
        (PJMEDIA_ERRNO_START + 224) /* 220224 */
/**
 * @hideinitializer
...
#    define PJMEDIA_SRTP_DTLS_EPEERNOCERT \
        (PJMEDIA_ERRNO_START + 241) /* 220241 */
...
#    define PJMEDIA_SRTP_DTLS_EFPNOTMATCH \
        (PJMEDIA_ERRNO_START + 242) /* 220242 */
...
#    define PJMEDIA_SRTP_DTLS_ENOPROFILE \
        (PJMEDIA_ERRNO_START + 244) /* 220244 */
 ...
 */
PJ_DECL(pj_str_t)
pjmedia_strerror(pj_status_t status, char* buffer, pj_size_t bufsize);
