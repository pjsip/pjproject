 ...
 * might get notified from the callback set from #pjmedia_conf_set_op_cb() or
 * #pjmedia_conf_set_op_cb2(). 
 *
 ...
 * #pjmedia_conf_set_op_cb()/#pjmedia_conf_set_op_cb2() to receive notification
 * upon completion.
 * 
