 ...
 */
PJ_DECL(pj_status_t)
pjmedia_transport_srtp_get_setting(pjmedia_transport* srtp,
 ...
 */
PJ_DECL(pj_status_t)
pjmedia_transport_srtp_modify_setting(pjmedia_transport* srtp,
                                      const pjmedia_srtp_setting* opt);
 ...
 */
PJ_DECL(pj_status_t)
pjmedia_transport_srtp_start(pjmedia_transport* srtp,
