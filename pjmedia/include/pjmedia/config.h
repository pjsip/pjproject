...
#    ifdef _MSC_VER
#        pragma message( \
          "Warning: PJMEDIA_HAS_SMALL_FILTER macro is deprecated" \
          " and has no effect")
#    else
#        warning \
          "PJMEDIA_HAS_SMALL_FILTER macro is deprecated and has no effect"
#    endif
#endif
...
#    error \
      "PJMEDIA_HAS_LIBRESAMPLE macro is deprecated. Use '#define PJMEDIA_RESAMPLE_IMP PJMEDIA_RESAMPLE_LIBRESAMPLE'"
#endif

#ifdef PJMEDIA_HAS_SPEEX_RESAMPLE
#    error \
      "PJMEDIA_HAS_SPEEX_RESAMPLE macro is deprecated. Use '#define PJMEDIA_RESAMPLE_IMP PJMEDIA_RESAMPLE_SPEEX'"
#endif
...
#define PJMEDIA_RESAMPLE_LIBRESAMPLE \
    2 /**< Sample rate conversion \
           using libresample.  */
#define PJMEDIA_RESAMPLE_SPEEX \
    3 /**< Sample rate conversion \
           using Speex. */
#define PJMEDIA_RESAMPLE_LIBSAMPLERATE \
