...
#define PJMEDIA_RTCP_XR_BUF_SIZE \
    sizeof(pjmedia_rtcp_xr_rb_rr_time) + sizeof(pjmedia_rtcp_xr_rb_dlrr) + \
      sizeof(pjmedia_rtcp_xr_rb_stats) + sizeof(pjmedia_rtcp_xr_rb_voip_mtc)
 ...
 */
PJ_DECL(void)
pjmedia_rtcp_build_rtcp_xr(pjmedia_rtcp_xr_session* session, unsigned rpt_types,
 ...
 */
PJ_DECL(pj_status_t)
pjmedia_rtcp_xr_update_info(pjmedia_rtcp_xr_session* session, unsigned info,
                            pj_int32_t val);
...
void pjmedia_rtcp_xr_rx_rtcp_xr(pjmedia_rtcp_xr_session* session,
                                const void* rtcp_pkt, pj_size_t size);
 ...
 */
void pjmedia_rtcp_xr_rx_rtp(pjmedia_rtcp_xr_session* session, unsigned seq,
