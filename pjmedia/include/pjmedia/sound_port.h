 ...
 */
PJ_DECL(pj_status_t)
pjmedia_snd_port_create_rec(pj_pool_t* pool, int index, unsigned clock_rate,
 ...
 */
PJ_DECL(pj_status_t)
pjmedia_snd_port_create_player(pj_pool_t* pool, int index, unsigned clock_rate,
