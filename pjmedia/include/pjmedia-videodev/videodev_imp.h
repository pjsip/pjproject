...
typedef struct pjmedia_vid_dev_factory_op
{
     ...
     *			successfully.
     */
    pj_status_t (*get_dev_info)(pjmedia_vid_dev_factory* f, unsigned index,
     ...
     */
    pj_status_t (*default_param)(pj_pool_t* pool, pjmedia_vid_dev_factory* f,
                                 unsigned index, pjmedia_vid_dev_param* param);
