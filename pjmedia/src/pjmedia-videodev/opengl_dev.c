...
#include <pj/log.h>
  ...
  defined(PJMEDIA_VIDEO_DEV_HAS_OPENGL) && PJMEDIA_VIDEO_DEV_HAS_OPENGL != 0
...
static pj_status_t opengl_factory_create_stream(
...
static pjmedia_vid_dev_factory_op factory_op = {
    &opengl_factory_init,          &opengl_factory_destroy,
    &opengl_factory_get_dev_count, &opengl_factory_get_dev_info,
    &opengl_factory_default_param, &opengl_factory_create_stream,
...
static pj_status_t opengl_factory_init(pjmedia_vid_dev_factory* f)
{
    ...
    qf->dev_info = (struct opengl_dev_info*)pj_pool_calloc(
      qf->pool, 1, sizeof(struct opengl_dev_info));
  ...
  pjmedia_vid_dev_stream** p_vid_strm)
{
    ...
    return pjmedia_vid_dev_opengl_imp_create_stream(pool, param, cb, user_data,
                                                    p_vid_strm);
}
