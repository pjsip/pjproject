...
pjmedia_codec_mgr_enum_codecs(pjmedia_codec_mgr* mgr, unsigned* count,
                              pjmedia_codec_info codecs[], unsigned* prio)
{
    unsigned i;
                         ...
                         unsigned max_len)
{
    ...
    len = pj_ansi_snprintf(
      id, max_len, "%.*s/%u/%u", (int)info->encoding_name.slen,
      info->encoding_name.ptr, info->clock_rate, info->channel_cnt);
                                    ...
                                    pjmedia_codec_param* param)
{
    ...
    if (codec_desc && codec_desc->param) {
        ...
        pj_memcpy(param, codec_desc->param->param, sizeof(pjmedia_codec_param));
