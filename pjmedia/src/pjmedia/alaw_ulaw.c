 ...
 */
PJ_DEF(pj_uint8_t)
pjmedia_linear2alaw(int pcm_val) /* 2's complement (16-bit range) */
{
    int mask;
    int seg;
    unsigned char aval;
 ...
 *
 */
PJ_DEF(int) pjmedia_alaw2linear(unsigned a_val)
{
    int t;
    int seg;
...
pjmedia_linear2ulaw(int pcm_val) /* 2's complement (16-bit range) */
{
    int mask;
    int seg;
    unsigned char uval;
 ...
 */
PJ_DEF(int) pjmedia_ulaw2linear(unsigned char u_val)
{
    int t;
...
PJ_DEF(unsigned char) pjmedia_alaw2ulaw(unsigned char aval)
{
    aval &= 0xff;
...
PJ_DEF(unsigned char) pjmedia_ulaw2alaw(unsigned char uval)
{
    uval &= 0xff;
