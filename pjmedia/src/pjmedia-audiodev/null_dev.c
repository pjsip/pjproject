...
static pjmedia_aud_dev_factory_op factory_op = {
    &null_factory_init,          &null_factory_destroy,
    &null_factory_get_dev_count, &null_factory_get_dev_info,
    &null_factory_default_param, &null_factory_create_stream,
    &null_factory_refresh
};

static pjmedia_aud_stream_op stream_op = {
    &null_stream_get_param, &null_stream_get_cap, &null_stream_set_cap,
    &null_stream_start,     &null_stream_stop,    &null_stream_destroy
};
...
static pj_status_t null_factory_init(pjmedia_aud_dev_factory* f)
{
    ...
    nf->dev_count = 1;
    nf->dev_info = (struct null_audio_dev_info*)pj_pool_calloc(
      nf->pool, nf->dev_count, sizeof(struct null_audio_dev_info));
    ndi = &nf->dev_info[0];
