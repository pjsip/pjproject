...
void ScaleARGBRowDown2Box_NEON(const uint8* src_ptr,
                               ...
                               uint8* dst,
                               int dst_width);
void ScaleARGBRowDown2_MSA(const uint8* src_argb,
                           ptrdiff_t src_stride,
                           uint8* dst_argb,
                           int dst_width);
void ScaleARGBRowDown2Linear_MSA(const uint8* src_argb,
                                 ptrdiff_t src_stride,
                                 uint8* dst_argb,
                                 int dst_width);
void ScaleARGBRowDown2Box_MSA(const uint8* src_argb,
                              ptrdiff_t src_stride,
                              uint8* dst_argb,
                              int dst_width);
...
void ScaleARGBRowDown2Box_Any_NEON(const uint8* src_ptr,
                                   ...
                                   uint8* dst,
                                   int dst_width);
void ScaleARGBRowDown2_Any_MSA(const uint8* src_argb,
                               ptrdiff_t src_stride,
                               uint8* dst_argb,
                               int dst_width);
void ScaleARGBRowDown2Linear_Any_MSA(const uint8* src_argb,
                                     ptrdiff_t src_stride,
                                     uint8* dst_argb,
                                     int dst_width);
void ScaleARGBRowDown2Box_Any_MSA(const uint8* src_argb,
                                  ptrdiff_t src_stride,
                                  uint8* dst_argb,
                                  int dst_width);
...
void ScaleARGBRowDownEvenBox_NEON(const uint8* src_argb,
                                  ...
                                  uint8* dst_argb,
                                  int dst_width);
void ScaleARGBRowDownEven_MSA(const uint8* src_argb,
                              ptrdiff_t src_stride,
                              int32 src_stepx,
                              uint8* dst_argb,
                              int dst_width);
...
void ScaleARGBRowDownEvenBox_Any_NEON(const uint8* src_argb,
                                      ...
                                      uint8* dst_argb,
                                      int dst_width);
void ScaleARGBRowDownEven_Any_MSA(const uint8* src_argb,
                                  ptrdiff_t src_stride,
                                  int32 src_stepx,
                                  uint8* dst_argb,
                                  int dst_width);
...
void ScaleRowDown2_MSA(const uint8* src_ptr,
                       ptrdiff_t src_stride,
                       uint8* dst,
                       int dst_width);
void ScaleRowDown2Linear_MSA(const uint8* src_ptr,
                             ptrdiff_t src_stride,
                             uint8* dst,
                             int dst_width);
void ScaleRowDown2Box_MSA(const uint8* src_ptr,
                          ptrdiff_t src_stride,
                          uint8* dst,
                          int dst_width);
void ScaleRowDown4_MSA(const uint8* src_ptr,
                       ptrdiff_t src_stride,
                       uint8* dst,
                       int dst_width);
void ScaleRowDown4Box_MSA(const uint8* src_ptr,
                          ptrdiff_t src_stride,
                          uint8* dst,
                          int dst_width);
void ScaleRowDown38_MSA(const uint8* src_ptr,
                        ptrdiff_t src_stride,
                        uint8* dst,
                        int dst_width);
void ScaleRowDown38_2_Box_MSA(const uint8* src_ptr,
                              ptrdiff_t src_stride,
                              uint8* dst_ptr,
                              int dst_width);
void ScaleRowDown38_3_Box_MSA(const uint8* src_ptr,
                              ptrdiff_t src_stride,
                              uint8* dst_ptr,
                              int dst_width);
void ScaleAddRow_MSA(const uint8* src_ptr, uint16* dst_ptr, int src_width);
...
void ScaleRowDown2_Any_MSA(const uint8* src_ptr,
                           ptrdiff_t src_stride,
                           uint8* dst,
                           int dst_width);
void ScaleRowDown2Linear_Any_MSA(const uint8* src_ptr,
                                 ptrdiff_t src_stride,
                                 uint8* dst,
                                 int dst_width);
void ScaleRowDown2Box_Any_MSA(const uint8* src_ptr,
                              ptrdiff_t src_stride,
                              uint8* dst,
                              int dst_width);
void ScaleRowDown4_Any_MSA(const uint8* src_ptr,
                           ptrdiff_t src_stride,
                           uint8* dst,
                           int dst_width);
void ScaleRowDown4Box_Any_MSA(const uint8* src_ptr,
                              ptrdiff_t src_stride,
                              uint8* dst,
                              int dst_width);
void ScaleRowDown38_Any_MSA(const uint8* src_ptr,
                            ptrdiff_t src_stride,
                            uint8* dst,
                            int dst_width);
void ScaleRowDown38_2_Box_Any_MSA(const uint8* src_ptr,
                                  ptrdiff_t src_stride,
                                  uint8* dst_ptr,
                                  int dst_width);
void ScaleRowDown38_3_Box_Any_MSA(const uint8* src_ptr,
                                  ptrdiff_t src_stride,
                                  uint8* dst_ptr,
                                  int dst_width);
void ScaleAddRow_Any_MSA(const uint8* src_ptr,
                         uint16* dst_ptr,
                         int src_width);
