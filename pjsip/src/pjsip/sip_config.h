/* $Header: /pjproject/pjsip/src/pjsip/sip_config.h 8     8/31/05 9:05p Bennylp $ */
/* 
 * PJSIP - SIP Stack
...
#define PJSIP_MAX_CALL_ID_LEN		PJ_GUID_LENGTH
#define PJSIP_MAX_TAG_LEN		PJ_GUID_LENGTH
#define PJSIP_MAX_BRANCH_LEN		(PJSIP_RFC3261_BRANCH_LEN + PJ_GUID_LENGTH)
