...
pjsip_cfg_t pjsip_sip_cfg_var = {
    /* Global settings */
    { PJSIP_ALLOW_PORT_IN_FROMTO_HDR, PJSIP_ACCEPT_REPLACE_IN_EARLY_STATE, 0, 0,
      PJSIP_DONT_SWITCH_TO_TCP, PJSIP_DONT_SWITCH_TO_TLS,
      PJSIP_FOLLOW_EARLY_MEDIA_FORK, PJSIP_REQ_HAS_VIA_ALIAS,
      PJSIP_RESOLVE_HOSTNAME_TO_GET_INTERFACE, 0, PJSIP_ENCODE_SHORT_HNAME,
      PJSIP_ACCEPT_MULTIPLE_SDP_ANSWERS, 0 },

    /* Transaction settings */
    { PJSIP_MAX_TSX_COUNT, PJSIP_T1_TIMEOUT, PJSIP_T2_TIMEOUT, PJSIP_T4_TIMEOUT,
      PJSIP_TD_TIMEOUT },
