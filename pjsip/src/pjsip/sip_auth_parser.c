...
const pj_str_t pjsip_USERNAME_STR = { "username", 8 },
               ...
               pjsip_NONCE_STR = { "nonce", 5 }, pjsip_URI_STR = { "uri", 3 },
               pjsip_RESPONSE_STR = { "response", 8 },
               pjsip_ALGORITHM_STR = { "algorithm", 9 },
               pjsip_DOMAIN_STR = { "domain", 6 },
               pjsip_STALE_STR = { "stale", 5 }, pjsip_QOP_STR = { "qop", 3 },
               pjsip_CNONCE_STR = { "cnonce", 6 },
               pjsip_OPAQUE_STR = { "opaque", 6 }, pjsip_NC_STR = { "nc", 2 },
               ...
               pjsip_BEARER_STR = { "Bearer", 6 }, pjsip_MD5_STR = { "MD5", 3 },
