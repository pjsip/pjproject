 ...
 */
PJ_DECL(pj_status_t)
pjsip_unregister_hdr_parser(const char* hname, const char* hshortname,
                            pjsip_parse_hdr_func* fptr);
 ...
 */
PJ_DECL(pj_status_t)
pjsip_unregister_uri_parser(const char* scheme, pjsip_parse_uri_func* func);
 ...
 */
PJ_DECL(pjsip_uri*)
pjsip_parse_uri(pj_pool_t* pool, char* buf, pj_size_t size, unsigned options);
 ...
 */
PJ_DECL(void*)
pjsip_parse_hdr(pj_pool_t* pool, const pj_str_t* hname, char* line,
...
#    pragma warning(push)
#    pragma warning( \
      disable : 4510)  // default constructor could not be generated
#    pragma warning( \
