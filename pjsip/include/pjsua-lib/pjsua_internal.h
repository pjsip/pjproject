...
struct pjsua_call_media
{
    ...
    pj_status_t (*med_create_cb)(pjsua_call_media* call_med, pj_status_t status,
 ...
 * Duplicate IM data.
 */
PJ_INLINE(pjsua_im_data*)
pjsua_im_data_dup(pj_pool_t* pool, const pjsua_im_data* src)
{
    pjsua_im_data* dst;
