...
typedef struct pjsua_call_setting
{
    ...
    /**
     * Custom Call-ID to be sent out with outgoing INVITE. Overrides default
     * Call-ID generated by dialog.
     *
     * This setting will only be used when creating a new outgoing call via pjsua_call_make_call().
     */
