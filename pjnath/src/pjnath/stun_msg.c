...
struct attr_desc
{
    ...
    pj_status_t (*encode_attr)(const void* a, pj_uint8_t* buf, unsigned len,
                               const pj_stun_msg_hdr* msghdr,
                               unsigned* printed);
    void* (*clone_attr)(pj_pool_t* pool, const void* src);
};

static pj_status_t decode_sockaddr_attr(pj_pool_t* pool, const pj_uint8_t* buf,
                                        const pj_stun_msg_hdr* msghdr,
                                        void** p_attr);
...
static pj_status_t decode_string_attr(pj_pool_t* pool, const pj_uint8_t* buf,
                                      const pj_stun_msg_hdr* msghdr,
                                      void** p_attr);
...
static pj_status_t decode_msgint_attr(pj_pool_t* pool, const pj_uint8_t* buf,
                                      const pj_stun_msg_hdr* msghdr,
                                      void** p_attr);
...
static pj_status_t decode_errcode_attr(pj_pool_t* pool, const pj_uint8_t* buf,
                                       const pj_stun_msg_hdr* msghdr,
                                       void** p_attr);
...
static pj_status_t decode_unknown_attr(pj_pool_t* pool, const pj_uint8_t* buf,
                                       const pj_stun_msg_hdr* msghdr,
                                       void** p_attr);
...
static pj_status_t decode_uint_attr(pj_pool_t* pool, const pj_uint8_t* buf,
                                    const pj_stun_msg_hdr* msghdr,
                                    void** p_attr);
...
static pj_status_t decode_uint64_attr(pj_pool_t* pool, const pj_uint8_t* buf,
                                      const pj_stun_msg_hdr* msghdr,
                                      void** p_attr);
...
static pj_status_t decode_binary_attr(pj_pool_t* pool, const pj_uint8_t* buf,
                                      const pj_stun_msg_hdr* msghdr,
                                      void** p_attr);
...
static pj_status_t decode_empty_attr(pj_pool_t* pool, const pj_uint8_t* buf,
                                     const pj_stun_msg_hdr* msghdr,
                                     void** p_attr);
...
static struct attr_desc mandatory_attr_desc[] = {
    ...
    { /* PJ_STUN_ATTR_MAPPED_ADDR, */
      "MAPPED-ADDRESS", &decode_sockaddr_attr, &encode_sockaddr_attr,
      &clone_sockaddr_attr },
    { /* PJ_STUN_ATTR_RESPONSE_ADDR, */
      "RESPONSE-ADDRESS", &decode_sockaddr_attr, &encode_sockaddr_attr,
      &clone_sockaddr_attr },
    { /* PJ_STUN_ATTR_CHANGE_REQUEST, */
      "CHANGE-REQUEST", &decode_uint_attr, &encode_uint_attr,
      &clone_uint_attr },
    { /* PJ_STUN_ATTR_SOURCE_ADDR, */
      "SOURCE-ADDRESS", &decode_sockaddr_attr, &encode_sockaddr_attr,
      &clone_sockaddr_attr },
    { /* PJ_STUN_ATTR_CHANGED_ADDR, */
      "CHANGED-ADDRESS", &decode_sockaddr_attr, &encode_sockaddr_attr,
      &clone_sockaddr_attr },
    { /* PJ_STUN_ATTR_USERNAME, */
      "USERNAME", &decode_string_attr, &encode_string_attr,
      &clone_string_attr },
    { /* PJ_STUN_ATTR_PASSWORD, */
      "PASSWORD", &decode_string_attr, &encode_string_attr,
      &clone_string_attr },
    { /* PJ_STUN_ATTR_MESSAGE_INTEGRITY, */
      "MESSAGE-INTEGRITY", &decode_msgint_attr, &encode_msgint_attr,
      &clone_msgint_attr },
    { /* PJ_STUN_ATTR_ERROR_CODE, */
      "ERROR-CODE", &decode_errcode_attr, &encode_errcode_attr,
      &clone_errcode_attr },
    { /* PJ_STUN_ATTR_UNKNOWN_ATTRIBUTES, */
      "UNKNOWN-ATTRIBUTES", &decode_unknown_attr, &encode_unknown_attr,
      &clone_unknown_attr },
    { /* PJ_STUN_ATTR_REFLECTED_FROM, */
      "REFLECTED-FROM", &decode_sockaddr_attr, &encode_sockaddr_attr,
      &clone_sockaddr_attr },
    { /* PJ_STUN_ATTR_CHANNEL_NUMBER (0x000C) */
      "CHANNEL-NUMBER", &decode_uint_attr, &encode_uint_attr,
      &clone_uint_attr },
    ...
    { /* PJ_STUN_ATTR_XOR_PEER_ADDRESS, */
      "XOR-PEER-ADDRESS", &decode_xored_sockaddr_attr, &encode_sockaddr_attr,
      &clone_sockaddr_attr },
    { /* PJ_STUN_ATTR_DATA, */
    ...
    { /* PJ_STUN_ATTR_XOR_RELAYED_ADDR, */
      "XOR-RELAYED-ADDRESS", &decode_xored_sockaddr_attr, &encode_sockaddr_attr,
      &clone_sockaddr_attr },
    { /* PJ_STUN_ATTR_REQUESTED_ADDR_FAMILY, */
      "REQUESTED-ADDRESS-FAMILY", &decode_uint_attr, &encode_uint_attr,
      &clone_uint_attr },
    { /* PJ_STUN_ATTR_EVEN_PORT, */
      "EVEN-PORT", &decode_uint_attr, &encode_uint_attr, &clone_uint_attr },
    { /* PJ_STUN_ATTR_REQUESTED_TRANSPORT, */
      "REQUESTED-TRANSPORT", &decode_uint_attr, &encode_uint_attr,
      &clone_uint_attr },
    { /* PJ_STUN_ATTR_DONT_FRAGMENT */
      "DONT-FRAGMENT", &decode_empty_attr, &encode_empty_attr,
      &clone_empty_attr },
    ...
    { /* PJ_STUN_ATTR_XOR_MAPPED_ADDRESS, */
      "XOR-MAPPED-ADDRESS", &decode_xored_sockaddr_attr, &encode_sockaddr_attr,
      &clone_sockaddr_attr },
    { /* PJ_STUN_ATTR_TIMER_VAL, */
      "TIMER-VAL", &decode_uint_attr, &encode_uint_attr, &clone_uint_attr },
    { /* PJ_STUN_ATTR_RESERVATION_TOKEN, */
      "RESERVATION-TOKEN", &decode_uint64_attr, &encode_uint64_attr,
      &clone_uint64_attr },
    { /* PJ_STUN_ATTR_XOR_REFLECTED_FROM, */
      "XOR-REFLECTED-FROM", &decode_xored_sockaddr_attr, &encode_sockaddr_attr,
      &clone_sockaddr_attr },
    { /* PJ_STUN_ATTR_PRIORITY, */
      "PRIORITY", &decode_uint_attr, &encode_uint_attr, &clone_uint_attr },
    { /* PJ_STUN_ATTR_USE_CANDIDATE, */
      "USE-CANDIDATE", &decode_empty_attr, &encode_empty_attr,
      &clone_empty_attr },
...
static struct attr_desc extended_attr_desc[] = {
    ...
    { /* PJ_STUN_ATTR_SOFTWARE, */
      "SOFTWARE", &decode_string_attr, &encode_string_attr,
      &clone_string_attr },
    { /* PJ_STUN_ATTR_ALTERNATE_SERVER, */
      "ALTERNATE-SERVER", &decode_sockaddr_attr, &encode_sockaddr_attr,
      &clone_sockaddr_attr },
    { /* PJ_STUN_ATTR_REFRESH_INTERVAL, */
      "REFRESH-INTERVAL", &decode_uint_attr, &encode_uint_attr,
      &clone_uint_attr },
    ...
    { /* PJ_STUN_ATTR_ICE_CONTROLLED, */
      "ICE-CONTROLLED", &decode_uint64_attr, &encode_uint64_attr,
      &clone_uint64_attr },
    { /* PJ_STUN_ATTR_ICE_CONTROLLING, */
      "ICE-CONTROLLING", &decode_uint64_attr, &encode_uint64_attr,
      &clone_uint64_attr }
};
...
static const struct attr_desc* find_attr_desc(unsigned attr_type)
{
    ...
    pj_assert(
      mandatory_attr_desc[PJ_STUN_ATTR_END_MANDATORY_ATTR].decode_attr == NULL);
    ...
    pj_assert(PJ_ARRAY_SIZE(extended_attr_desc) ==
              PJ_STUN_ATTR_END_EXTENDED_ATTR -
                PJ_STUN_ATTR_START_EXTENDED_ATTR);
    ...
    if (attr_type < PJ_STUN_ATTR_END_MANDATORY_ATTR)
        ...
        desc =
          &extended_attr_desc[attr_type - PJ_STUN_ATTR_START_EXTENDED_ATTR];
    else
        return NULL;
...
#define INIT_ATTR(a, t, l) \
    (a)->hdr.type = (pj_uint16_t)(t), (a)->hdr.length = (pj_uint16_t)(l)
...
{
    return (pj_uint32_t)((buf[pos + 0] << 24UL) | (buf[pos + 1] << 16UL) |
                         (buf[pos + 2] << 8UL) | (buf[pos + 3] << 0UL));
}
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_sockaddr_attr_init(pj_stun_sockaddr_attr* attr, int attr_type,
                           pj_bool_t xor_ed, const pj_sockaddr_t* addr,
                           unsigned addr_len)
{
    unsigned attr_len;
    ...
    PJ_ASSERT_RETURN(
      addr_len == sizeof(pj_sockaddr_in) || addr_len == sizeof(pj_sockaddr_in6),
      PJ_EINVAL);
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_sockaddr_attr_create(pj_pool_t* pool, int attr_type, pj_bool_t xor_ed,
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_msg_add_sockaddr_attr(pj_pool_t* pool, pj_stun_msg* msg, int attr_type,
                              pj_bool_t xor_ed, const pj_sockaddr_t* addr,
                              unsigned addr_len)
{
    pj_stun_sockaddr_attr* attr;
    ...
    status = pj_stun_sockaddr_attr_create(pool, attr_type, xor_ed, addr,
                                          addr_len, &attr);
                                        ...
                                        void** p_attr)
{
    ...
    pj_memcpy(pj_sockaddr_get_addr(&attr->sockaddr), buf + ATTR_HDR_LEN + 4,
              addr_len);
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_string_attr_init(pj_stun_string_attr* attr, pj_pool_t* pool,
                         int attr_type, const pj_str_t* value)
{
    if (value && value->slen) {
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_string_attr_create(pj_pool_t* pool, int attr_type,
                           const pj_str_t* value, pj_stun_string_attr** p_attr)
{
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_msg_add_string_attr(pj_pool_t* pool, pj_stun_msg* msg, int attr_type,
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_empty_attr_create(pj_pool_t* pool, int attr_type,
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_uint_attr_create(pj_pool_t* pool, int attr_type, pj_uint32_t value,
...
PJ_DEF(pj_status_t)
pj_stun_msg_add_uint_attr(pj_pool_t* pool, pj_stun_msg* msg, int attr_type,
                          pj_uint32_t value)
{
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_uint64_attr_create(pj_pool_t* pool, int attr_type,
...
PJ_DEF(pj_status_t)
pj_stun_msg_add_uint64_attr(pj_pool_t* pool, pj_stun_msg* msg, int attr_type,
                            const pj_timestamp* value)
{
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_errcode_attr_create(pj_pool_t* pool, int err_code,
...
PJ_DEF(pj_status_t)
pj_stun_msg_add_errcode_attr(pj_pool_t* pool, pj_stun_msg* msg, int err_code,
                             const pj_str_t* err_reason)
{
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_unknown_attr_create(pj_pool_t* pool, unsigned attr_cnt,
...
PJ_DEF(pj_status_t)
pj_stun_msg_add_unknown_attr(pj_pool_t* pool, pj_stun_msg* msg,
                             unsigned attr_cnt, const pj_uint16_t attr_type[])
{
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_binary_attr_init(pj_stun_binary_attr* attr, pj_pool_t* pool,
                         int attr_type, const pj_uint8_t* data, unsigned length)
{
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_binary_attr_create(pj_pool_t* pool, int attr_type,
                           const pj_uint8_t* data, unsigned length,
...
PJ_DEF(pj_status_t)
pj_stun_msg_add_binary_attr(pj_pool_t* pool, pj_stun_msg* msg, int attr_type,
                            const pj_uint8_t* data, unsigned length)
{
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_msg_init(pj_stun_msg* msg, unsigned msg_type, pj_uint32_t magic,
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_msg_create(pj_pool_t* pool, unsigned msg_type, pj_uint32_t magic,
                   const pj_uint8_t tsx_id[12], pj_stun_msg** p_msg)
{
    pj_stun_msg* msg;
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_msg_check(const pj_uint8_t* pdu, pj_size_t pdu_len, unsigned options)
{
    pj_uint32_t msg_len;
...
PJ_DEF(pj_status_t)
pj_stun_msg_create_response(pj_pool_t* pool, const pj_stun_msg* req_msg,
                            unsigned err_code, const pj_str_t* err_msg,
                            pj_stun_msg** p_response)
{
    ...
    if (err_code) {
        status =
          pj_stun_msg_add_errcode_attr(pool, response, err_code, err_msg);
        if (status != PJ_SUCCESS) {
            return status;
        }
    }
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_msg_decode(pj_pool_t* pool, const pj_uint8_t* pdu, pj_size_t pdu_len,
                   unsigned options, pj_stun_msg** p_msg,
                   pj_size_t* p_parsed_len, pj_stun_msg** p_response)
{
    pj_stun_msg* msg;
    ...
    while (pdu_len >= 4) {
        ...
        if (pdu_len < attr_val_len) {
            ...
            if (p_response) {
                pj_stun_msg_create_response(pool, msg, PJ_STUN_SC_BAD_REQUEST,
                                            &err_msg, p_response);
            }
            return PJNATH_ESTUNINATTRLEN;
        }
        ...
        if (adesc == NULL) {
            ...
            PJ_LOG(5,
                   (THIS_FILE, "Unrecognized attribute type 0x%x", attr_type));
            ...
            if (attr_type <= 0x7FFF) {
                ...
                if (p_response) {
                    ...
                    status = pj_stun_msg_create_response(pool, msg, err_code,
                                                         NULL, p_response);
                    if (status == PJ_SUCCESS) {
            ...
            if (msg->attr_count >= PJ_STUN_MAX_ATTR) {
                if (p_response) {
                    pj_stun_msg_create_response(
                      pool, msg, PJ_STUN_SC_SERVER_ERROR, NULL, p_response);
                }
            ...
            if (status != PJ_SUCCESS) {
                ...
                PJ_LOG(
                  4, (THIS_FILE, "Error parsing unknown STUN attribute type %d",
                      attr_type));
            ...
            if (status != PJ_SUCCESS) {
                ...
                if (p_response) {
                    ...
                    pj_stun_msg_create_response(
                      pool, msg, PJ_STUN_SC_BAD_REQUEST, &e, p_response);
                }

                PJ_LOG(4, (THIS_FILE, "Error parsing STUN attribute %s: %s",
                           pj_stun_get_attr_name(attr_type), err_msg1));
            ...
            if (attr_type == PJ_STUN_ATTR_MESSAGE_INTEGRITY && !has_fingerprint)
            {
                if (has_msg_int) {
                    ...
                    if (p_response) {
                        pj_stun_msg_create_response(
                          pool, msg, PJ_STUN_SC_BAD_REQUEST, NULL, p_response);
                    }
 ...
 */
PJ_DEF(pj_status_t)
pj_stun_msg_encode(pj_stun_msg* msg, pj_uint8_t* buf, pj_size_t buf_size,
                   unsigned options, const pj_str_t* key, pj_size_t* p_msg_len)
{
    ...
    for (i = 0; i < msg->attr_count; ++i) {
        ...
        if (adesc) {
            ...
            const pj_stun_binary_attr* bin_attr =
              (const pj_stun_binary_attr*)attr_hdr;
    ...
    if (amsgint != NULL) {
        ...
        status = encode_msgint_attr(amsgint, buf, (unsigned)buf_size, &msg->hdr,
                                    &printed);
        if (status != PJ_SUCCESS)
            return status;
 ...
 * index.
 */
PJ_DEF(pj_stun_attr_hdr*)
pj_stun_msg_find_attr(const pj_stun_msg* msg, int attr_type, unsigned index)
{
 ...
 */
PJ_DEF(pj_stun_attr_hdr*)
pj_stun_attr_clone(pj_pool_t* pool, const pj_stun_attr_hdr* attr)
{
    const struct attr_desc* adesc;
    ...
    if (adesc) {
        ...
        const pj_stun_binary_attr* bin_attr = (const pj_stun_binary_attr*)attr;
