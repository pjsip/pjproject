 ...
 */
PJ_DECL(void)
pj_turn_allocation_on_rx_client_pkt(pj_turn_allocation* alloc,
                                    pj_turn_pkt* pkt);
...
struct pj_turn_transport
{
    ...
    /** Sendto handler */
    pj_status_t (*sendto)(pj_turn_transport* tp, const void* packet,
                          pj_size_t size, unsigned flag,
                          const pj_sockaddr_t* addr, int addr_len);

    /** Addref handler */
    void (*add_ref)(pj_turn_transport* tp, pj_turn_allocation* alloc);

    /** Decref handler */
    void (*dec_ref)(pj_turn_transport* tp, pj_turn_allocation* alloc);
};
 ...
 */
PJ_DECL(pj_status_t)
pj_turn_listener_create_udp(pj_turn_srv* srv, int af,
                            const pj_str_t* bound_addr, unsigned port,
                            unsigned concurrency_cnt, unsigned flags,
 ...
 */
PJ_DECL(pj_status_t)
pj_turn_listener_create_tcp(pj_turn_srv* srv, int af,
                            const pj_str_t* bound_addr, unsigned port,
                            unsigned concurrency_cnt, unsigned flags,
                            pj_turn_listener** p_lis);
 ...
 */
PJ_DECL(pj_status_t)
pj_turn_srv_create(pj_pool_factory* pf, pj_turn_srv** p_srv);
 ...
 */
PJ_DECL(void) pj_turn_srv_on_rx_pkt(pj_turn_srv* srv, pj_turn_pkt* pkt);
